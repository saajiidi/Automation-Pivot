    ...
    with st.container():
        ...
        if focus in ("all", "visual_analytics"):
            ...
            with v1:
                ...
                pos_array = ['auto' if (val / max(total_cat_rev, 1)) >= 0.02 else 'none' for val in summ['Total Amount']]
                ...
                st.plotly_chart(fig_pie, use_container_width=True, config={"scrollZoom": True, "displayModeBar": False})
            ...
            with v2:
                ...
                st.plotly_chart(fig_bar, use_container_width=True, config={"scrollZoom": True, "displayModeBar": False})
...
def render_dashboard_output(drill, summ, top, timeframe, basket, source_name, last_updated="N/A"):
    ...
    st.plotly_chart(fig_top, use_container_width=True, config={"scrollZoom": True, "displayModeBar": False})
